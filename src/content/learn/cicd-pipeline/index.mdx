...
A **CI/CD pipeline** automates the software delivery process from code commit to production deployment. It consists of two main practices:

- **Continuous Integration (CI)**: Automatically merge code changes, run tests, and catch issues early
